...
def wait_until_dns_server_is_up(
    args, dns_server_subprocess, dns_server_subprocess_output
):
    for i in range(0, 30):
        test_runner_log(
...
current_test_subprocess = subprocess.Popen(
    [
        ...
        "",
        "--expected_service_config_error",
        "clientLanguage error:is not an array",
        "--expected_lb_policy",
        "",
        "--enable_srv_queries",
        "True",
...
current_test_subprocess = subprocess.Popen(
    [
        ...
        "",
        "--expected_service_config_error",
        "percentage error:failed to parse number",
        "--expected_lb_policy",
        "",
        "--enable_srv_queries",
        "True",
...
current_test_subprocess = subprocess.Popen(
    [
        ...
        "",
        "--expected_service_config_error",
        "field:loadBalancingPolicy error:is not a string",
        "--expected_lb_policy",
        "",
        "--enable_srv_queries",
        "True",
