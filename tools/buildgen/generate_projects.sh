...
generate_projects_virtual_environment/bin/pip install grpcio-tools==1.74.0
generate_projects_virtual_environment/bin/pip list

# Generate xds-protos.
generate_projects_virtual_environment/bin/python tools/distrib/python/xds_protos/build.py

# Make other grpc python modules.
