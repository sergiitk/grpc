...
_DATA_MEMBERS = [
    ...
    return certificate_verifier_.get();
        ...
        special_comparator="(certificate_verifier_ == other.certificate_verifier_ || (certificate_verifier_ != nullptr && other.certificate_verifier_ != nullptr && certificate_verifier_->Compare(other.certificate_verifier_.get()) == 0))",
    ...
    DataMember(
        ...
        getter_comment="Returns the distributor from certificate_provider_ if it is set, nullptr otherwise.",
    ...
    return nullptr;
        ...
        setter_move_semantics=True,
        special_comparator="(certificate_provider_ == other.certificate_provider_ || (certificate_provider_ != nullptr && other.certificate_provider_ != nullptr && certificate_provider_->Compare(other.certificate_provider_.get()) == 0))",
        test_name="DifferentCertificateProvider",
        test_value_1='MakeRefCounted<StaticDataCertificateProvider>("root_cert_1", PemKeyCertPairList())',
        test_value_2='MakeRefCounted<StaticDataCertificateProvider>("root_cert_2", PemKeyCertPairList())',
    ),
    DataMember(
        name="watch_root_cert",
        type="bool",
        default_initializer="false",
        setter_comment="If need to watch the updates of root certificates with name |root_cert_name|. The default value is false. If used in tls_credentials, it should always be set to true unless the root certificates are not needed.",
    ...
    DataMember(
        ...
        setter_comment="Sets the name of root certificates being watched, if |set_watch_root_cert| is called. If not set, an empty string will be used as the name.",
        setter_move_semantics=True,
    ...
    DataMember(
        ...
        type="bool",
        default_initializer="false",
        setter_comment="If need to watch the updates of identity certificates with name |identity_cert_name|. The default value is false. If used in tls_credentials, it should always be set to true unless the identity key-cert pairs are not needed.",
    ...
    DataMember(
        ...
        type="std::string",
        special_getter_return_type="const std::string&",
        setter_comment="Sets the name of identity key-cert pairs being watched, if |set_watch_identity_pair| is called. If not set, an empty string will be used as the name.",
        setter_move_semantics=True,
    ...
    DataMember(
        ...
        type="std::string",
        special_getter_return_type="const std::string&",
        setter_comment=" gRPC will enforce CRLs on all handshakes from all hashed CRL files inside of the crl_directory. If not set, an empty string will be used, which will not enable CRL checking. Only supported for OpenSSL version > 1.1.",
        setter_move_semantics=True,
