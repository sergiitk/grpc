...
def _generate_junit_report_string(
    ...
    if success:
        ...
        test_output_tag = (
            '<failure message="Failure">FAILED. See bazel invocation results here: %s</failure>'
            % bazel_invocation_url
        )
...
if __name__ == "__main__":
    ...
    argp.add_argument(
        ...
        required=True,
        type=str,
        help="Path under which the bazel wrapper and other files are going to be generated",
    )
    argp.add_argument(
        "--report_suite_name",
